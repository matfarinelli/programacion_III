...
public class MySimpleLinkedList implements Iterable<Integer> {
	...
	public MyIterator iteratorReverse() {
		return new MyIterator(last);
	}
...
*/
	...
	public boolean isPalindromo(MyIterator it1, MyIterator it2) {
		while (it1.hasNext()) {
			if (it1.get() == it2.get()) {
				System.out.println(it1.get());
